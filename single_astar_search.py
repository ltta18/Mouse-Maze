...
def single_astar(maze_size, wall_positions, prize_list, start_position):
    """
...
def print_solution(maze_filename, maze_output):
    ...
    solution = single_astar(maze_size, wall_positions, prize_list, start_position)
...
if __name__ == "__main__":
    print_solution('1prize-large.txt','astar_maze_output_large.txt')
    print_solution('1prize-medium.txt','astar_maze_output_medium.txt')
    print_solution('1prize-open.txt','astar_maze_output_open.txt')